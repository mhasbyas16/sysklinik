                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                      <div class="input-group date">
                                                        ...
                                                        <input type="text" class="form-control pull-right" value="{{Request::is('data-pasien/view/*') ? $data->tgl_daftar:''}}" id="datedaftar" name="tanggal_daftar">
                                                      </div>
                                                      <!-- /.input group -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-8" style="padding-left: 30pt">
                                                      <select class="form-control select2" style="width: 100%;" name="assesor" value=" " >
                                                        <option value="@if(Request::is('data-pasien/view/*')) @if ($count==0) @else {{$isiA->assesor}} @endif @endif" hidden>@if(Request::is('data-pasien/view/*')) @if ($count==0)-- Select One -- @else {{$isiA->assesor}} @endif @endif</option>
                                                        @foreach($kar as $kar)
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-7">
                                                      <select class="form-control select2" style="width: 100%;" name="J_terapi" value=" " >
                                                        <option value="@if(Request::is('data-pasien/view/*')) @if ($count==0) @else {{$isiA->id_terapi}} @endif @endif" hidden>@if(Request::is('data-pasien/view/*')) @if ($count==0) -- Select One -- @else {{$isiA->terapi}} @endif @endif</option>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-sm-7">
                                                      <select class="form-control select2" style="width: 100%;" name="status" value=" " >
                                                        <option value="{{Request::is('data-pasien/view/*') ? $data->status:''}}" hidden>{{Request::is('data-pasien/view/*') ? $data->status:''}}</option>
