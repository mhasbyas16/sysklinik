    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box box-solid">
          <!-- begin data alat-->
          <form class="form-horizontal" action="{{ url('rekamedis') }}" method="post">
            @csrf
            <div class="box-body">
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-md-12 text-center">
                      <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="id_rm" required>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="col-sm-7">
                          <select class="form-control" name="id_pasien">
                            @foreach($pasien as $psn)
                              <option value="{{ $psn->id_pasien }}">{{ $psn->id_pasien }}</option>
                            @endforeach
                          </select>
                        </div>
                      </div>
