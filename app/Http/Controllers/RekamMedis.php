...
class RekamMedis extends Controller
{
    ...
    {
        $rekam_medis = DB::table('h_rekam_medis')->select('h_rekam_medis.id_rm', 'h_rekam_medis.id_pasien')->join('d_pasien', 'h_rekam_medis.id_pasien', '=', 'd_pasien.id_pasien')->get();
    ...
    {
        $rekam_medis = DB::table('h_rekam_medis')->select('h_rekam_medis.id_rm', 'h_rekam_medis.id_pasien')->join('d_pasien', 'h_rekam_medis.id_pasien', '=', 'd_pasien.id_pasien')->get();
        $pasien = DB::table('d_pasien')->select('d_pasien.*')->join('h_pasien', 'd_pasien.id_pasien', '=', 'h_pasien.id_pasien')->get();
