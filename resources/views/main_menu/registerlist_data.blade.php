                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" value="{{$data->tgl_lahir}}" id="datepicker" name="tanggal_lahir">
                          </div>
                          <!-- /.input group -->
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right" value="{{$data->tgl_daftar}}" id="datedaftar" name="tanggal_daftar">
                          </div>
                          <!-- /.input group -->
                        </div>
                    </div>
